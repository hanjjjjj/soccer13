    ...
    <div class="site-wrap">
        ...
        <div class="container site-section pb-0">
            ...
            <div class="row align-items-center mb-2">
                <div class="col-6">
                    <h2 class="section-title">Our Ballon d'Or Player</h2>
                </div>
            </div>
            <div class="item player">
                <div style="text-align: center;">

                    <a href="#"><img src="/resources/css2/images/B0/BalonOro_Ronaldo2.jpg" alt="Image" class="img-fluid"width="624px" height="624px"></a>
                    <div class="p-4">
                        <h3>RONALDO</h3>
                        <p>#9 / Forward</p>
                        <p>Ballon d'Or 1997 2002  </p>
                        <p>
                            2002 Real Madrid CF ~ 2007 Real Madrid CF
                        </p>
                        <video src="/resources/video/RonaldoNazarioBalonOro_1.mp4" width="700" height="700" controls></video>
                    </div>
                </div>
            </div>
        </div>
